...
data object LibraryTab : Tab {
    ...
    override fun Content() {
        ...
        val onClickContinueReading = {
            scope.launchIO {
                val history = screenModel.getLastReadHistory()
                if (history != null) {
                    ...
                    snackbarHostState.showSnackbar(
                        context.stringResource(MR.strings.information_no_recent_manga),
                    )
                }
            }
            Unit
        ...
        Scaffold(
            topBar = { scrollBehavior ->
                ...
                LibraryToolbar(
                    ...
                    onClickPreviewUpdate = if (isDebugBuildType) {
                        {
                            navigator.push(
                                NewUpdateScreen(
                                    versionName = "v0.20.17",
                                    changelogInfo = """
                                        - Added a subtle indicator when 18+ content is hidden.
                                        - Curated the recommended source list.
                ...
                if (state.selection.isEmpty()) {
                    FloatingActionButton(
                        ...
                        Icon(
                            ...
                            contentDescription = context.stringResource(MR.strings.action_resume),
                        )
                    }
                }
            },
            ...
            when {
                ...
                state.searchQuery.isNullOrEmpty() && !state.hasActiveFilters && state.isLibraryEmpty -> {
                    ...
                    LibraryContent(
                        ...
                        onClickManga = { navigator.push(MangaScreen(it, fromLibrary = true)) },
