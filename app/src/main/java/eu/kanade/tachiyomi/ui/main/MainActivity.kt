...
import yomudoom.feature.support.SupportUsScreen
...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setComposeContent {
            ...
            val sourceLoadingProgress by extensionManager.loadingProgress.collectAsState()

            val isSystemInDarkTheme = isSystemInDarkTheme()
            val statusBarBackgroundColor = when {
                sourceLoadingProgress != null -> IndexingBannerBackgroundColor
                ...
                Scaffold(
                    topBar = {
                        AppStateBanners(
                            ...
                            indexing = indexing,
                            sourceLoadingProgress = sourceLoadingProgress,
    ...
    private fun ShowDonationCampaign() {
            ...
            AdaptiveSheet(
                ...
                Column {
                    ...
                    OutlinedButton(
                        ...
                        Text(text = stringResource(MR.strings.donationCampaign_dismiss))
                    }
                }
            }
        }
        ...
        LaunchedEffect(Unit) {
            try {
                ...
                val eligibleTime = Instant.fromEpochMilliseconds(firstInstallTime).plus(180.days)
...
// Splash screen
private const val SPLASH_MIN_DURATION = 250 // ms
