...
class NotificationReceiver : BroadcastReceiver() {
    ...
    private val nsfwContentFilter: NsfwContentFilter by injectLazy()
    ...
    private fun openChapter(context: Context, mangaId: Long, chapterId: Long) {
        ...
        if (manga != null && !nsfwContentFilter.isMangaAllowed(manga)) {
            context.toast(MR.strings.content_blocked_nsfw)
        } else if (manga != null && chapter != null) {
    ...
    private fun markAsRead(chapterUrls: Array<String>, mangaId: Long) {
        ...
        launchIO {
            ...
            if (!nsfwContentFilter.isMangaAllowed(manga)) return@launchIO
